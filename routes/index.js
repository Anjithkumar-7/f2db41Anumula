...
router.get('/', function(req, res, next) {
  res.render('index', { title: 'Aeroplane App', user : req.user } );
});


router.get('/register', function(req, res) { 
  res.render('register', { title: 'Aeroplane App Registration'}); 
}); 
...
router.get('/login', function(req, res) { 
    res.render('login', { title: 'Aeroplane App Login', user : req.user }); 
}); 
